package com.generation.mundogamer.service;
...
import com.generation.mundogamer.model.Usuario;
import com.generation.mundogamer.model.UsuarioLogin;
import com.generation.mundogamer.repository.UsuarioRepository;
	...
	public Optional<UsuarioLogin> autenticarUsuario(Optional<UsuarioLogin> usuarioLogin){
		...
		if(buscaUsuario.isPresent()) {
			...
			if( compararSenhas(usuarioLogin.get().getSenha(), buscaUsuario.get().getSenha()) ) {
				...
				usuarioLogin.get().setDatadeNascimento(buscaUsuario.get().getDataNascimento());
